...
export default function ScaleExercise() {
  ...
  const applyDifficultyPreset = useCallback(
    (preset: DifficultyPreset) => {
      ...
      setDirection(next.direction as DirectionMode);
    },
    [setDifficultyPreset, setDirection, setEnabled, setRangeId],
  );
    ...
    <div className="flex flex-col gap-6">
      ...
      {round.phase === "idle" ? (
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="rounded-3xl bg-zinc-950/42 border border-white/12 shadow-[inset_0_1px_0_rgba(255,255,255,0.065),0_16px_46px_rgba(0,0,0,0.18)] backdrop-blur-xl p-5 min-h-[140px] flex flex-col items-center justify-center gap-3">
      ...
      <SettingsCard>
        ...
        <Field label="播放方向">
          <SegBar
            ...
            onChange={(v) => {
              markCustomDifficulty();
              setDirection(v as DirectionMode);
            }}
          />
        </Field>
        <Field label="根音">
